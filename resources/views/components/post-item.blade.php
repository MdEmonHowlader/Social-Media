<div>
    <div class="flex bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 mb-8">
        <div class="p-5 flex-1">
            ...
            <a href="#">
                ...
                <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="rou>nd" stroke-width="2"
        ...
        <a href="#">
            <img class= " w-48 h-full object-cover rounded-t-lg" src="https://flowbite.com/docs/images/blog/image-1.jpg"
                alt="" />
        </a>
    </div>
</div>
