    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <span class="text-2xl font-bold text-blue-600 ">EMON<span
                                class="text-green-900 text-3xl font-extrabold">.</span></span>
                    </a>
                </div>
            ...
            <div class="flex">
                ...
                @endauth
                @guest
                    <a href="{{ route('register') }}" class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-primary-button>
                            Register
                        </x-primary-button>
                        Create An Account
